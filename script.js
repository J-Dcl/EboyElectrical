...
// --- Custom Formspree Submission & Redirect ---
const quoteForm = document.querySelector('.quote-form');

if (quoteForm) {
    quoteForm.addEventListener('submit', async function(event) {
        event.preventDefault(); // Stops the default formspree page from loading

        const form = event.target;
        const data = new FormData(form);

        // Change the button text so the user knows it is sending
        ...
        try {
            ...
            if (response.ok) {
                // Success! Force the redirect to your custom page
